...
const Stats = () => {
  ...
  return (
    <main className='font-poppins h-full py-10 pb-28'>
        <section className='flex md:flex-row pb-6 text-3xl md:text-6xl font-extrabold text-red2 items-center justify-center'>
        ...
        <section className='flex flex-wrap gap-10 justify-center pb-2'>
